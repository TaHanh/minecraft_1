...
class IntentAnimation {
  static Future intentNomal(
    ...
    return Navigator.of(context)
        .push(SlideRoute(page: screen, option: option, exitScreen: exitScreen, duration: duration));
  }
  ...
  static Future intentPushReplacement(
      ...
      @required Duration duration}) {
    return Navigator.of(context)
        .pushReplacement(SlideRoute(page: screen, option: option, exitScreen: exitScreen, duration: duration));
  }
...
void pushNavigator(context, screen, callBack) async {
